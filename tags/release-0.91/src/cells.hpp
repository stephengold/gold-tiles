...
public:
    ...
    // Cells(Cells const&);  implicitly defined copy constructor
    // ~Cells(void);  implicitly defined destructor

    // public operators
    // Cell& operator=(Cell const&);  implicitly defined assignment operator 
